      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="serial_noField" class="col-md-3 form-label">serial no</label>
              <div class="col-md-9">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control" id="brandField" name="brand">
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control" id="purchase_dateField" name="purchase_date">
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            <div class="mb-3 row">
              <label for="addserial_noField" class="col-md-3 form-label">serial_no</label>
              <div class="col-md-9">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="brand" class="form-control" id="addbrandField" name="brand">
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control" id="addpurchase_dateField" name="purchase_date">
              </div>
            </div>
            <div class="text-center">
              <button type="submit" class="btn btn-primary">Submit</button>
